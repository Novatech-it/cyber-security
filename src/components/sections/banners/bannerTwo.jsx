...
import banner_wapper_image from "../../../assets/images/Key.png"
        ...
        <section className="banner-wrapper-area">
            <div className="container-fluid">
                ...
                >
                    ...
                    <div className="col-lg-5 banner-two">
                        <motion.div className="banner-wrapper-image"
                            ...
                            viewport={{ once: true, amount: 0.4 }}
                        >
                            <img className="banner-two-img" src={banner_wapper_image} alt="banner-wrapper"/>
